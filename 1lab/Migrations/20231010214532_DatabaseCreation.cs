    ...
    public partial class DatabaseCreation : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ayditoryaId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ayditarya", x => x.ayditoryaId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_student_ayditarya_ayditoryaId",
                        column: x => x.ayditoryaId,
                        principalTable: "ayditarya",
                        principalColumn: "ayditoryaId",
            ...
            migrationBuilder.InsertData(
                table: "ayditarya",
                columns: new[] { "ayditoryaId", "Name" },
                values: new object[,]
                {
                    { new Guid("b4ca4fa1-b184-3cdc-3159-13b2180fa22a"), "504" },
                    { new Guid("b4d33fd4-b129-5dfd-2905-13d6416df55a"), "403" }
                });
